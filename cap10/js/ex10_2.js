...
window.addEventListener("load", () => {
    ...
    const num1_00 = Math.ceil(Math.randon() * 5)
    const num0_50 = Math.ceil(Math.randon() * 5)
    const num0_25 = Math.ceil(Math.randon() * 5)
    const num0_10 = Math.ceil(Math.randon() * 5)
 ...
 const criarMoedas = (num, moeda, texotAlt, classe) => {
    ...
    for (let i = 1; i <= num; i++) {
        ...
        novaMoeda.textAlt = texotAlt // texto alternativo
        novaMoeda.className = classe // classe de moeda(css)
