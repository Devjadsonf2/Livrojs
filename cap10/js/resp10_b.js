...
frm.addEventListener("submit", (e) => {
    ...
    const nome = frm.inNome.value.trim() // trim(): remove espaços em branco (no início e no final)
    ...
    const cores = ["blue","yellow","red","green","orange","chocolate","deeppink","purpple","violet","aquamarine"]
