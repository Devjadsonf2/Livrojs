...
frm.rbPizza.addEventListener("click", () => { // quando radiobutton é clicado
...
frm.inDetalhes.addEventListener("focus", () => { // quando campo recebe o foco
    if (frm.rbPizza.checked) { // se radiobutton rbPizza estiver marcado
        const pizza = frm.inPizza.value // obtém valor do item selecionado
...
frm.addEventListener("submit", (e) => {
    ...
    frm.inPizza.dispatchEvent(new Event("click")) // dispara click em rbPizza
})